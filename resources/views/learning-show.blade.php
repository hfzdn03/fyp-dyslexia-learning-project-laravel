            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <p class="mb-3"><b>Write on a piece of paper according to that is shown below and then upload the
                            image.</b></p>
                    <input type="text" class="form-control" style="font-size:30px;" value="{{ $learning->randomized_string }}"
                        readonly>
                    <form action="{{ route('learnings.update', ['id' => $learning->id]) }}" id="submitForm" method="POST"
                        ...
                        <button type="button" class="btn btn-primary" style="background-color:#0d6efd;"
                            onclick="validateForm()">Complete Re-do
                            Learning</button>
                    </form>
                </div>
            </div>
